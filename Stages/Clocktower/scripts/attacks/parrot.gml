...
set_hitbox_value(AT_USPECIAL, 2, HG_DAMAGE, 666);
set_hitbox_value(AT_USPECIAL, 2, HG_BASE_KNOCKBACK, 100);
set_hitbox_value(AT_USPECIAL, 2, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_USPECIAL, 2, HG_BASE_HITPAUSE, 100);
set_hitbox_value(AT_USPECIAL, 2, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_ell_eject"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("parrotFly"));
