...
set_window_value(AT_DTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 7);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("Claw2"));
...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_Y, 2);
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 20);
set_hitbox_value(AT_DTILT, 2, HG_HEIGHT, 10);
