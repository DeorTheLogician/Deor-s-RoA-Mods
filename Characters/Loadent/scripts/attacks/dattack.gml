...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_land_light"));

set_window_value(AT_DATTACK, 3, AG_WINDOW_LENGTH, 9);
set_window_value(AT_DATTACK, 3, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_DATTACK, 3, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(AT_DATTACK, 3, AG_WINDOW_HAS_WHIFFLAG, 15);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("Claw3"));
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("Claw3"));
