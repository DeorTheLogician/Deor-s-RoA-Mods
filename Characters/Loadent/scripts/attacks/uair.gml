...
set_window_value(AT_UAIR, 3, AG_WINDOW_HAS_WHIFFLAG, 15);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, Sweet );
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("Sweet"));
