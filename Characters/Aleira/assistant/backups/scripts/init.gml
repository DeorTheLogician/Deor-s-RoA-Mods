...
// forward_moves[| 3] = AT_DSPECIAL;
// forward_moves[| 4] = AT_DSPECIAL_AIR;

//Moves that increase the stance value by 2.
skip_moves = ds_list_create();
skip_moves[| 0] = AT_FTILT;
skip_moves[| 1] = AT_FSTRONG;
skip_moves[| 2] = AT_FAIR;
skip_moves[| 3] = AT_FSPECIAL;
skip_moves[| 4] = AT_FSPECIAL_AIR;
skip_moves[| 5] = AT_DATTACK;
...
back_moves[| 3] = AT_USPECIAL;
// back_moves[| 4] = AT_USPECIAL_AIR;
...
var arr1 = array_create(100);
var arr2 = array_create(100);
var arr3 = array_create(100);

for(var i = 0; i < 100; i++) {
    arr1[i] = array_create(100);
    arr2[i] = array_create(100);
    arr3[i] = array_create(100);
}
...
//Attack data for AT_NAIR
move_data[AT_NAIR] = {
    properties: array_clone(arr1),
    windows:    array_clone(arr2),
    hitboxes:   array_clone(arr3)
};